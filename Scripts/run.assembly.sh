...
# Function: Plant Mitogenome Assembly Pipeline
#-----------------------------
...
# Step 5. Extending seed contigs and constructing initial assembly graph
	python3 Get_mitogenome_from_assembly.py	-c 454ContigGraph.txt -a 454AllContigs.fna -s 1234,1,312 -o Assembly.gfa
